...
- Keep most answers around 120-220 words unless the user asks for more detail
...
- Mention that results are educational and not guaranteed
- Use plain English
...
"""
    ...
    response = ollama.chat(
        ...
        messages=[
            {
                "role": "system",
                "content": "You create short, clear educational summaries for non-technical users.",
            },
